...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-04-2021 a las 01:09:14
...
CREATE TABLE `asignacion` (
  `FECHA_EMBARQUE_VIAJE` date NOT NULL,
...
CREATE TABLE `billete` (
  ...
  `CODIGO_CRUCERO` varchar(20) NOT NULL,
  `FECHA_EMBARQUE` varchar(20) NOT NULL,
...
CREATE TABLE `viaje` (
  `FECHA_EMBARQUE_VIAJE` date NOT NULL,
  `CODIGO_CRUCERO` varchar(20) NOT NULL,
  `DESCRIPCION_VIAJE` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `asignacion`
  ADD PRIMARY KEY (`FECHA_EMBARQUE_VIAJE`,`CODIGO_CRUCERO`,`CODIGO_EMPLEADO`),
  ADD KEY `CODIGO_EMPLEADO` (`CODIGO_EMPLEADO`),
  ADD KEY `asignacion_ibfk_1` (`CODIGO_CRUCERO`);

--
-- Indices de la tabla `billete`
--
ALTER TABLE `billete`
  ADD PRIMARY KEY (`NIE`,`FECHA_EMBARQUE`),
...
--
ALTER TABLE `paradas`
  ADD PRIMARY KEY (`FECHA_EMBARQUE_VIAJE`,`CODIGO_CRUCERO`,`NUMERO_PARADA`) USING BTREE,
  ADD KEY `CODIGO_CRUCERO` (`CODIGO_CRUCERO`),
...
--
ALTER TABLE `viaje`
  ADD PRIMARY KEY (`FECHA_EMBARQUE_VIAJE`,`CODIGO_CRUCERO`),
  ADD KEY `CODIGO_CRUCERO` (`CODIGO_CRUCERO`);
...
ALTER TABLE `billete`
  ...
  ADD CONSTRAINT `billete_ibfk_3` FOREIGN KEY (`CODIGO_CRUCERO`) REFERENCES `viaje` (`CODIGO_CRUCERO`);
...
--
ALTER TABLE `paradas`
  ADD CONSTRAINT `paradas_ibfk_1` FOREIGN KEY (`CODIGO_CRUCERO`) REFERENCES `viaje` (`CODIGO_CRUCERO`),
  ADD CONSTRAINT `paradas_ibfk_3` FOREIGN KEY (`CODIGO_PUERTO`) REFERENCES `puerto` (`CODIGO_PUERTO`),
  ADD CONSTRAINT `paradas_ibfk_4` FOREIGN KEY (`FECHA_EMBARQUE_VIAJE`) REFERENCES `viaje` (`FECHA_EMBARQUE_VIAJE`);
